...
main (int argc, char **argv)
{
	...
	pmap_unset (SMOKER_PROG, SMOKER_VERS);
	...
	if (!svc_register(transp, SMOKER_PROG, SMOKER_VERS, smoker_prog_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (SMOKER_PROG, SMOKER_VERS, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, SMOKER_PROG, SMOKER_VERS, smoker_prog_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (SMOKER_PROG, SMOKER_VERS, tcp).");
		exit(1);
	}
